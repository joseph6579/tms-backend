...
from dispatch.api.serializers.orders import DispatchOrdersSerializer
...
class OrderManagementViewset(ReadOnlyModelViewSet):
    ...
    def dispatch_orders(self, request, *args, **kwargs):
        ...
        driver_id = data.get('driver_profile_id', None)

        orders = Order.objects.filter(id__in=order_ids)
        profile = DriverProfile.objects.get(id=driver_id) if driver_id else None
